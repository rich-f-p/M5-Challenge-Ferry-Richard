...
public class InvoiceServiceLayerTest {
    ...
    public void setUp() throws Exception {
        ...
        service = new InvoiceServiceLayer(
                invoiceRepository,taxRepository,processingFeeRepository,client
        );
    }
    ...
    private void setUpInvoiceRepositoryMock() {
        ...
        Invoice invoiceViewModel2 = new Invoice();
        invoiceViewModel2.setId(105);
        invoiceViewModel.setName("John Jake");
        invoiceViewModel.setStreet("street");
        invoiceViewModel.setCity("Charlotte");
        invoiceViewModel.setState("NY");
        ...
        doReturn(invoiceViewModel2).when(invoiceRepository).save(invoiceViewModel);
        doReturn(Optional.of(invoice1)).when(invoiceRepository).findById(105L);
    ...
    private void setUpClientMock() {
        ...
        tShirt2.setDescription("sleeveless");
        tShirt2.setPrice(new BigDecimal("400"));
        tShirt2.setQuantity(30);

        doReturn(Optional.of(tShirt)).when(client).getTShirtById(54L);
        doReturn(Optional.of(tShirt2)).when(client).getTShirtById(99L);
    }
}