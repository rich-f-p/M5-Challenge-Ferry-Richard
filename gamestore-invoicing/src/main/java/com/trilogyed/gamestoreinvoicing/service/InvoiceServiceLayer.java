...
public class InvoiceServiceLayer {
    ...
    @Autowired
    public InvoiceServiceLayer(InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo, GameStoreCatalogClient client) {
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            ...
            Optional<ConsoleViewModel> returnVal = client.getConsoleById(invoiceViewModel.getItemId());
            ...
            Optional<GameViewModel> returnVal = client.getGameById(invoiceViewModel.getItemId());
            ...
            Optional<TShirtViewModel> returnVal = client.getTShirtById(invoiceViewModel.getItemId());
        ...
        if (!(tempTaxRate.compareTo(BigDecimal.ZERO) ==0))
